...
def knn_tuning(trainImages, testImages, trainLabels, testLabels, k_values, distance_metrics, featureType):
    ...
    for k_value in k_values:
        ...
        for distance_metric in distance_metrics:
            ...
            dist = cdist(trainImages, testImages, metric=distance_metric)
    ...
    df.to_csv('csvLogs/K_accuracy_' + featureType + '.csv', index=False)
