...
def my_SVC(trainSet, trainLabels, testSet, testLabels, featureType, max_num_iter=10000, showClassificationReport=False):
    ...
    plot_SVM_histogram_kernels(kernels_verbose, np.array(list(accuracies.values())), featureType, "Kernels", "Accuracies", saveFig=True, savingPath=folder_path, showFig=True)
...
def testDifferentSVMclassifiers(trainSetPath, testSetPath, imageSize, usePCA, max_num_iter=10000, showClassificationReport=False):
    ...
    # Call SVC
    my_SVC(trainImages, trainLabels, testImages, testLabels, "Raw pixels BW features", max_num_iter, showClassificationReport)
    my_SVC(trainHistograms, trainLabels, testHistograms, testLabels, "Histogram (b&w) features", max_num_iter, showClassificationReport)
    #------------------------------------------------------------------------------------------------------------------#
    ...
    if usePCA:
        ...
        goalVarHist = 0.85    #Imposing the goal variance to achieve (HISTOGRAMS)
        trainImages, testImages, trainHistograms, testHistograms = reduce_dimensionality(trainImages, imageSize, trainLabels, testImages, testLabels,
                                                                                         goalVarPixel, goalVarHist, trainHistograms, testHistograms)
    # Call SVC
    my_SVC(trainImages, trainLabels, testImages, testLabels, "Raw pixel RGB features", max_num_iter, showClassificationReport)
    my_SVC(trainHistograms, trainLabels, testHistograms, testLabels, "Histogram (RGB) features", max_num_iter, showClassificationReport)
    #------------------------------------------------------------------------------------------------------------------#
    ...
    if usePCA:
        ...
        trainImages, testImages, trainHistograms, testHistograms = reduce_dimensionality(trainImages, imageSize, trainLabels, testImages, testLabels,
                                                                                         goalVarPixel, goalVarHist, trainHistograms, testHistograms)
    # Call SVC
    my_SVC(trainImages, trainLabels, testImages, testLabels, "Mean pixel features", max_num_iter, showClassificationReport)
    my_SVC(trainHistograms, trainLabels, testHistograms, testLabels, "Histogram (HSV) features", max_num_iter, showClassificationReport)
